...
from utils import SPARK_DATA_PATH, get_spark_context


sc = get_spark_context("DegreesOfSeparation")
...
def convert_to_bfs(line):
    ...
    connections = list(map(int, fields[1:]))
...
def create_starting_rdd():
    input_file = sc.textFile(f"{SPARK_DATA_PATH}/Marvel-graph.txt")
